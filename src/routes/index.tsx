        ...
        <div className="relative z-10 flex flex-col items-center gap-6 text-center">
          ...
          <div className="mt-4 flex items-center gap-4 font-mono text-sm text-fg-muted">
            <Link
              ...
              className="underline decoration-border underline-offset-4 hover:decoration-fg-subtle"
            >
              projects
            </Link>
        ...
        <div className="mx-auto max-w-5xl">
          <Section>
            <div className="grid gap-8 md:grid-cols-3">
              {['Systems', 'Web', 'AI'].map((label) => {
                const descMap: Record<string, string> = {
                  Systems: 'Distributed systems, databases, OS internals',
                  Web: 'Full-stack apps with TanStack, React, and Go',
                  AI: 'LLM pipelines, Whisper, vector search, on-device inference',
                }
                return (
